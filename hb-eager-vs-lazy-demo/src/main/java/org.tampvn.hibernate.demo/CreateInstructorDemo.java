...
public class CreateInstructorDemo {
    public static void main(String[] args) {
        ...
        try{
            ...
            //create the objects
            Instructor tempInstructor = new Instructor("Toan", "Le", "chupeloatchoat@gmail.com");

            InstructorDetail tempInstructorDetail = new InstructorDetail("www.youtube.com", "rapping");
